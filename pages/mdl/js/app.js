...
function loadMessages(snapshot) {
    ...
    chat.initMessages('.page[data-page="messages"]');
}
...
// Login
function login() {
    chat.prompt('Enter your nickname please?', function (data) {
        username = data;
        //checkIfUserExists(username);

        if (username != '') {

            chat.alert('Ok, you are now logged in as ' + username + ' ;)');
